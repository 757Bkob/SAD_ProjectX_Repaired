UndefineClass('TurretGalacticLaserTurretWired')
DefineClass.TurretGalacticLaserTurretWired = {
	__parents = { "LaserTurret", "MalfunctionOverTimeComponent", "PowerComponent" },
